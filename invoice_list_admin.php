...
<div class="row justify-content-center mx-auto">
    <div class="btn-group mb-2 ">
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=1">1~2月</a>
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=2">3~4月</a>
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=3">5~6月</a>
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=4">7~8月</a>
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=5">9~10月</a>
        <a id="aaa" class="btn btn-outline-light " href="?do=invoice_list_admin&pd=6">11~12月</a>
    </div>
        ...
        ?>
            <tbody>
                <tr>
                    ...
                    <td><?= $row['payment']; ?></td>
                    <td>
                        <a href="?do=edit_invoice_admin&id=<?= $row['id']; ?>"><button class="btn btn-outline-light fas fa-highlighter" data-toggle="tooltip" data-placement="top" title="編輯"></button></a>
