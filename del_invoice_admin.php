...
if(isset($_GET['del'])){
    ...
    header("location:admin.php?do=invoice_list_admin");
}else{
...
<div class="col-md-7 mx-auto ">
  ...
  <div class="text-center mt-2">
      <a class="btn btn-outline-danger" href="?do=del_invoice_admin&del=1&id=<?=$_GET['id'];?>">確認</a>
    <a class="btn btn-outline-dark" href="?do=invoice_list_admin">取消</a>
    </div>
    </div>
<?php
}
