...
<body>
    <div class="container">
        <a href="mem.php" style="text-decoration:none;">
        ...
        <div class="col-12 d-flex justify-content-between p-3 mx-auto ">
            ...
            $m = ceil(date("m") / 2);
            ?>
            <a href="?do=invoice_list_mem&pd=<?=$m;?>"><h3><?= $month[$m]; ?></h3></a>
            <div class="text-center ">
                <a href="?do=invoice_list_mem" class="btn btn-outline-light">當期發票</a>
            </div>
            <div class="text-center">
                <a href="?do=award_numbers" class="btn btn-outline-light">對獎</a>
            </div>
            <div class="text-center">
                <a href="mem.php" class="btn btn-outline-light">輸入發票</a>
            </div>
            <div class="text-center">
