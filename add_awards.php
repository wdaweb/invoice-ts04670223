      ...
      <tbody>
        ...
        <tr>
          ...
          <td headers="group1" class="number">
            <input class="form-control col-4" type="number" name="special_prize" min="00000001" max="99999999"></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td headers="group2" class="number">
            <input class="form-control col-4" type="number" name="grand_prize" min="00000001" max="99999999">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td headers="group3" class="number">
            <input class="form-control col-3 d-inline" type="number" name="first_prize[]" min="00000001" max="99999999">
            <input class="form-control col-3 d-inline" type="number" name="first_prize[]" min="00000001" max="99999999">
            <input class="form-control col-3 d-inline" type="number" name="first_prize[]" min="00000001" max="99999999">
            <p></p>
          </td>
